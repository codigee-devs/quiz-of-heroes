...
@Injectable()
class SaveUserInstanceUseCase implements UseCase<void, UserInstanceEntity> {
  final UserInstanceRepository _repository;
  const SaveUserInstanceUseCase(this._repository);

  @override
  Future<Either<Failure, void>> call(UserInstanceEntity entity) async => await _repository.saveUserInstance(
        UserInstanceDto(
          level: entity.level,
